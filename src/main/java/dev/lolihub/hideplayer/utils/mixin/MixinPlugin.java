package dev.lolihub.hideplayer.utils.mixin;

import dev.lolihub.hideplayer.config.MixinConfig;
...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        var baseName = mixinClassName.substring(mixinClassName.lastIndexOf('.') + 1);
        return Boolean.parseBoolean(MixinConfig.getConfig().getProperty(baseName, "true"));
    }
